export const projects = [
  ...
  },
  {
    ...
    description:
      "Join a neighborhood effort to improve public spaces and raise awareness about sustainability.",
    imageURL: "/images/placeholder-project.svg",
  ...
  },
  {
    ...
    description:
      "Mentor students in beginner-friendly coding activities and help them build confidence with technology.",
    imageURL: "/images/placeholder-project.svg",
  ...
  },
  {
    ...
    description:
      "Support a library initiative by organizing books, creating study spaces, and welcoming new visitors.",
    imageURL: "/images/placeholder-project.svg",
    category: ["Community", "Education"],
    difficulty: "Beginner",
    teamSize: "3/6",
  ...
  },
  {
    ...
    description:
      "Work alongside neighbors to plant, maintain, and harvest produce for shared use.",
    imageURL: "/images/placeholder-project.svg",
    category: ["Community", "Environment"],
    difficulty: "Beginner",
    teamSize: "7/12",
  ...
  },
  {
    ...
    description:
      "Assist older adults with basic device setup, online safety, and digital communication skills.",
    imageURL: "/images/placeholder-project.svg",
  ...
  },
  {
    ...
    description:
      "Collaborate with artists and residents to create a mural that celebrates the local community.",
    imageURL: "/images/placeholder-project.svg",
  ...
  },
  {
    ...
    description:
      "Help prepare supplies, coordinate outreach, and support families affected by sudden emergencies.",
    imageURL: "/images/placeholder-project.svg",
  ...
  },
  {
    ...
    description:
      "Provide one-on-one academic support and encourage students to stay engaged in learning.",
    imageURL: "/images/placeholder-project.svg",
  ...
  },
  {
    ...
    description:
      "Help plan events, manage logistics, and create a welcoming space for local storytellers and performers.",
    imageURL: "/images/placeholder-project.svg",
    category: ["Arts", "Community"],
    difficulty: "Intermediate",
    teamSize: "6/10",
